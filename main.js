//Task 1 - In the first line of the program, define a variable called userName that is set to an empty string. If you want to, you can enter your name in between the quotation marks.
let userName = 'David';
...
let userQuestion = 'Will I learn to code Javascript?'
...
//Task 5 - We need to generate a random number between 0 and 7. Create another variable, and name it randomNumber. Set it equal to this expression, which uses two methods (Math.floor() and Math.random()) from the Math library.
...
//Execute using swtich statement syntax
...
//Task 9 - Extra practice! Execute using if else conditionals if you wrote with a switch statement, or vice versa

/* Commented out so it doesn't run. Comment out case statement and task 8 console.log if you want to uncomment this block of code.
